...
// //       onLongPress:()=>Provider.of<TripDetailsProvider>(context,listen:false).deleteTripById,
// //       child: Container(
// //         width: 150,
...
// void onLongPress(BuildContext context,String tripId){
  
//   Provider.of<TripDetailsProvider>(context, listen: false).deleteTripById(tripId);
// }
...
class TripCard extends StatelessWidget {
  ...
  void _showDeleteConfirmationDialog(BuildContext context, String tripId) {
    AwesomeDialog(
      ...
      title: 'Delete Trip',
      desc: 'Are you sure you want to delete this trip?',
      btnCancelOnPress: () {},
      btnOkOnPress: () {
